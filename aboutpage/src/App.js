...
class AboutPage extends React.Component {
  constructor(props) {
    ...
    this.imageArray = [   //Arrays for charity images
    ...
    this.descriptionArray = [   //Array for message images
  ...
  rightClick = () => {  //Functions for right clicks
    if (this.index < 3) {
      this.index++;
    } else {
      this.index = 0;
  ...
  render() { //Component renders from here
    return (
